...
public class DatabaseConnectionPool {
    ...
    public static final String DB_NAME = "bsds";
    public static final String DB_USER = "bsds";
    public static final String DB_PASSWORD = "password";
//    private static final String DB_HOST = "bsds.cpkn5gcvz0bw.us-west-2.rds.amazonaws.com";
    public static final String DB_HOST = "bsds.cno5ika9an5l.us-west-2.rds.amazonaws.com";
    public static final String PORT = "3306";
    public static final String JDBC_URL = "jdbc:mysql://" + DB_HOST + ":" + PORT + "/" + DB_NAME + "?user=" + DB_USER
